...
&#x20;   STARTING --> RUNNING: Motor feedback received

&#x20;   STARTING --> STOPPED: Stop button

&#x20;   STARTING --> FAULT: Motor feedback timeout



&#x20;   RUNNING --> STOPPED: Stop button

&#x20;   RUNNING --> STARTING: Motor feedback lost

&#x20;   RUNNING --> FAULT: Jam detected



&#x20;   FAULT --> STOPPED: Reset and emergency stop released



&#x20;   STOPPED --> FAULT: Emergency stop

&#x20;   STARTING --> FAULT: Emergency stop
...
If feedback is not received within 5 seconds, the system enters `FAULT` with a `MOTOR\_FEEDBACK\_ERROR`.
...
Jam monitoring is implemented in `FB\_JamDetector`.
...
Motor feedback supervision is implemented in `FB\_MotorFeedbackMonitor`.
...
| `NO\_FAULT` | No active fault |

| `EMERGENCY\_STOP` | Emergency stop input is active |

| `JAM\_DETECTED` | Product did not reach the exit sensor within the allowed time |

| `MOTOR\_FEEDBACK\_ERROR` | Motor feedback was not received within the timeout |
...
!\[Product in Transit](docs/04\_product\_in\_transit.png)
...
!\[Jam Detected](docs/05\_jam\_detected.png)
...
!\[Motor Feedback Fault](docs/06\_motor\_feedback\_fault.png)
...
!\[Emergency Stop](docs/07\_emergency\_stop.png)
